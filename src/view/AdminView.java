...
public class AdminView {
    ...
    private void showDashboard() {
        ...
        while (true) {
            ...
            switch (choice.charAt(0)) {
                case '1': printDataKaryawan(); break;
                case '2': crudMenu(); break;
                case '3': printLaporanPendapatan(); break;
                case '4': printMenuTerlaris(); break;
                case '5': crudStokBahan(); break;
                case '6': printGajiKaryawan(); break;
                case '7': 
    ...
    private void printDataKaryawan() {
        String[] options = {"Lihat Semua Karyawan", "Cari Berdasarkan NIK", "Kembali"};
        String choice = (String) JOptionPane.showInputDialog(null, "Print Data Karyawan:", "Pilih Aksi", 
            JOptionPane.QUESTION_MESSAGE, null, options, options[0]);
            
        if (choice == null || choice.equals("Kembali")) return;
        
        if (choice.equals("Lihat Semua Karyawan")) {
            String result = controller.printAllKaryawan();
            JOptionPane.showMessageDialog(null, result, "Daftar Karyawan", JOptionPane.INFORMATION_MESSAGE);
        } else {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "Tambah Menu":
                    ...
                    if (kategori == null || kategori.trim().isEmpty()) break;
                    
                    String kode = JOptionPane.showInputDialog("Kode Menu:");
                    if (kode == null || kode.trim().isEmpty()) break;
                    
                    String nama = JOptionPane.showInputDialog("Nama Menu:");
                    if (nama == null || nama.trim().isEmpty()) break;
                    
                    String hargaStr = JOptionPane.showInputDialog("Harga:");
                    if (hargaStr == null || hargaStr.trim().isEmpty()) break;
                    
                    String extra = "";
                    if (kategori.equalsIgnoreCase("minuman")) {
                ...
                case "Update Menu":
                    ...
                    if (kodeUpdate == null || kodeUpdate.trim().isEmpty()) break;
                    
                    String namaBaru = JOptionPane.showInputDialog("Nama Baru:");
                    if (namaBaru == null || namaBaru.trim().isEmpty()) break;
                    
                    String hargaBaruStr = JOptionPane.showInputDialog("Harga Baru:");
                    if (hargaBaruStr == null || hargaBaruStr.trim().isEmpty()) break;
                ...
                case "Nonaktifkan Menu":
                    ...
                    if (kodeDelete != null && !kodeDelete.trim().isEmpty()) {
        ...
        while (true) {
            ...
            switch (choice) {
                ...
                case "Tambah Bahan":
                    ...
                    if (stokStr == null || stokStr.trim().isEmpty()) break;
                    
                    String satuan = JOptionPane.showInputDialog("Satuan:");
                    if (satuan == null || satuan.trim().isEmpty()) break;
                ...
                case "Update Stok":
                    ...
                    if (stokBaruStr == null || stokBaruStr.trim().isEmpty()) break;
